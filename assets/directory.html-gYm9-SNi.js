import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,a as l,e,b as t,o as s}from"./app-CV6pBnLX.js";const a={},r=e("div",{class:"hint-container tip"},[e("p",{class:"hint-container-title"},"提示"),e("p",null,"Go语言项目业界公认的目录结构是怎样的❓")],-1),o=t(`<h2 id="目录结构" tabindex="-1"><a class="header-anchor" href="#目录结构"><span>目录结构</span></a></h2><blockquote><p>可以通过以下维度进行考量：</p><ul><li><p>命名清晰：目录命名需要简洁，清晰的表达出该目录实现的功能，做到一看到该目录名就知道是干嘛的；</p></li><li><p>功能明确：目录的功能必须明确，例如：api目录是接口服务、service目录是业务逻辑；</p></li><li><p>功能齐全：例如测试、构建、脚本、工具、文档等；</p></li></ul></blockquote><p>这里参考Go语言公认项目目录<a href="https://github.com/golang-standards/project-layout" target="_blank" rel="noopener noreferrer">project-layout</a>结构如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>.
├── api
├── assets
├── build
│   ├── ci
