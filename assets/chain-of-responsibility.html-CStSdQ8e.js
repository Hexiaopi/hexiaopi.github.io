import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as e,f as t,a as n,e as i}from"./app-5nld10jx.js";const l={},p=n("figure",null,[n("img",{src:"https://refactoringguru.cn/images/patterns/content/chain-of-responsibility/chain-of-responsibility-2x.png",alt:"责任链",tabindex:"0",loading:"lazy"}),n("figcaption",null,"责任链")],-1),c=i(`<h2 id="什么是责任链模式" tabindex="-1"><a class="header-anchor" href="#什么是责任链模式"><span>什么是责任链模式</span></a></h2><p>责任链模式(Chain of Responsibility)：为了避免请求发送者与多个请求处理者耦合在一起，将所有请求的处理者通过前一对象记住其下一个对象的引用而连成一条链；当有请求发生时，可将请求沿着这条链传递，直到有对象处理它为止。</p><div class="language-ascii line-numbers-mode" data-ext="ascii" data-title="ascii"><pre class="language-ascii"><code>     ┌─────────┐
     │ Request │
     └─────────┘
          │
┌ ─ ─ ─ ─ ┼ ─ ─ ─ ─ ┐
