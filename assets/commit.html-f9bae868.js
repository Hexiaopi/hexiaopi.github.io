...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="change-log" tabindex="-1"><a class="header-anchor" href="#change-log" aria-hidden="true">#</a> Change Log</h2>`,25),b=i("code",null,"CHANGELOG",-1),v=i("br",null,null,-1),g={href:"https://github.com/git-chglog/git-chglog",target:"_blank",rel:"noopener noreferrer"},p=i("code",null,"CHANGELOG",-1),f=l(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>git-chglog <span class="token parameter variable">-o</span> CHANGELOG.md
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="semver" tabindex="-1"><a class="header-anchor" href="#semver" aria-hidden="true">#</a> SemVer</h2>`,2),x={href:"https://github.com/arnaud-deprez/gsemver",target:"_blank",rel:"noopener noreferrer"};function _(y,k){const a=d("ExternalLinkIcon");return s(),o("div",null,[c,i("p",null,[e("Git每次提交代码，都需要写"),u,e("，好的规范例如："),i("a",m,[e("Angular规范"),n(a)]),e("，可以帮助我们：")]),h,i("p",null,[e("我们可以使用一些工具根据git提交记录自动生成"),b,e("，例如："),v,i("a",g,[e("git-chglog"),n(a)]),e("，本项目的"),p,e("就是使用该工具自动生成，非常方便。")]),f,i("p",null,[e("可以使用"),i("a",x,[e("gsemver"),n(a)]),e("工具根据git提交记录生成下一个版本")])])}const A=t(r,[["render",_],["__file","commit.html.vue"]]);export{A as default};
