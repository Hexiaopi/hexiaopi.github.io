import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,a as n,b as a,o as s}from"./app-DlI06yxL.js";const l="/assets/k8s-gpu-BhXFlt_0.png",d={},t=a(`<h1 id="gpu机器搭建k8s" tabindex="-1"><a class="header-anchor" href="#gpu机器搭建k8s"><span>gpu机器搭建k8s</span></a></h1><h2 id="查看gpu" tabindex="-1"><a class="header-anchor" href="#查看gpu"><span>查看GPU</span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>(base) root@ubuntu:~# lspci | grep -i nvidia
