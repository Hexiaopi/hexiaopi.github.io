import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as d,c as o,a as e,b as i,d as n,e as l}from"./app-170b167d.js";const r={},c=e("h2",{id:"commit-message",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#commit-message","aria-hidden":"true"},"#"),i(" Commit Message")],-1),u=e("code",null,"Commit message",-1),h={href:"https://github.com/angular/angular/blob/22b96b9/CONTRIBUTING.md#-commit-message-guidelines",target:"_blank",rel:"noopener noreferrer"},m=l(`<ul><li>根据摘要信息就可以知道每次变更哪些内容</li><li>可以过滤某些commit，例如只关注新增加的功能</li><li>根据commit生成<code>Change log</code></li></ul><p>在Angular规范中，Commit Message包含三个部分：Header、Body、Footer，格式如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;type&gt;(&lt;scope&gt;): &lt;subject&gt;
// 空一行
&lt;body&gt;
// 空一行
&lt;footer&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="change-log" tabindex="-1"><a class="header-anchor" href="#change-log" aria-hidden="true">#</a> Change Log</h2>`,25),b=e("code",null,"CHANGELOG",-1),v=e("br",null,null,-1),g={href:"https://github.com/git-chglog/git-chglog",target:"_blank",rel:"noopener noreferrer"},p=e("code",null,"CHANGELOG",-1),f=l(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>git-chglog <span class="token parameter variable">-o</span> CHANGELOG.md
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="semver" tabindex="-1"><a class="header-anchor" href="#semver" aria-hidden="true">#</a> SemVer</h2>`,2),x={href:"https://github.com/arnaud-deprez/gsemver",target:"_blank",rel:"noopener noreferrer"},_=e("h2",{id:"参考文献",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#参考文献","aria-hidden":"true"},"#"),i(" 参考文献")],-1),k={href:"https://www.conventionalcommits.org/zh-hans/v1.0.0/",target:"_blank",rel:"noopener noreferrer"};function y(C,N){const a=s("ExternalLinkIcon");return d(),o("div",null,[c,e("p",null,[i("Git每次提交代码，都需要写"),u,i("，好的规范例如："),e("a",h,[i("Angular规范"),n(a)]),i("，可以帮助我们：")]),m,e("p",null,[i("我们可以使用一些工具根据git提交记录自动生成"),b,i("变更日志，例如："),v,e("a",g,[i("git-chglog"),n(a)]),i("，本项目的"),p,i("就是使用该工具自动生成，非常方便。")]),f,e("p",null,[i("可以使用"),e("a",x,[i("gsemver"),n(a)]),i("工具根据git提交记录生成下一个版本")]),_,e("ul",null,[e("li",null,[e("a",k,[i("约定式提交"),n(a)])])])])}const B=t(r,[["render",y],["__file","commit.html.vue"]]);export{B as default};
