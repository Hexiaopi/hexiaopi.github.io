import{_ as c}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as l,c as u,b as r,e as n,d as a,w as e,f as s,a as o}from"./app-2efc0a4c.js";const d="/assets/interface-ded36672.png",k={},v=n("figure",null,[n("img",{src:"http://cdn.cjhe.top/blog/interface.png",alt:"interface",tabindex:"0",loading:"lazy"}),n("figcaption",null,"interface")],-1),b={class:"table-of-contents"},m=o(`<h2 id="接口不为nil的误区" tabindex="-1"><a class="header-anchor" href="#接口不为nil的误区" aria-hidden="true">#</a> 接口不为nil的误区</h2><p>我们看一个demo</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
eif = err: false
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details>`,3),y=n("code",null,"eface",-1),_=n("code",null,"_type",-1),w=n("code",null,"iface",-1),E=n("code",null,"tab._type",-1);function T(N,B){const t=p("router-link"),i=p("Badge");return l(),u("div",null,[v,r(" more "),n("nav",b,[n("ul",null,[n("li",null,[a(t,{to:"#接口不为nil的误区"},{default:e(()=>[s("接口不为nil的误区")]),_:1})]),n("li",null,[a(t,{to:"#接口类型底层结构"},{default:e(()=>[s("接口类型底层结构")]),_:1}),n("ul",null,[n("li",null,[a(t,{to:"#nil接口变量"},{default:e(()=>[s("nil接口变量")]),_:1})]),n("li",null,[a(t,{to:"#空接口类型变量"},{default:e(()=>[s("空接口类型变量")]),_:1})]),n("li",null,[a(t,{to:"#非空接口类型"},{default:e(()=>[s("非空接口类型")]),_:1})]),n("li",null,[a(t,{to:"#空接口类型和非空接口类型的等值比较"},{default:e(()=>[s("空接口类型和非空接口类型的等值比较")]),_:1})])])])])]),m,n("p",null,[s("针对"),f,s("这种赋值，非空接口类型变量的类型信息并不为空，数据指针为空，因此与"),g,s("不能画等号"),a(i,{text:"注意",type:"warning"}),h,s(" 因此文章开头"),x,s("返回的error接口类型变量不为nil也是这个原因。")]),q,n("p",null,[s("空接口类型变量和非空接口类型变量内部表示的结构不同，但Go进行等值比较时，类型比较使用的是"),y,s("的"),_,s("和"),w,s("的"),E,a(i,{text:"注意",type:"warning"}),s("。因此第6行两者之间是可以画等号的。")])])}const C=c(k,[["render",T],["__file","interface.html.vue"]]);export{C as default};
