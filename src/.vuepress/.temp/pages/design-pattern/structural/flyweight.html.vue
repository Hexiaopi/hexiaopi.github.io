<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/flyweight/flyweight-zh-2x.png" alt="flyweight" tabindex="0" loading="lazy"><figcaption>flyweight</figcaption></figure>
<!-- more -->
<h2 id="什么是享元模式" tabindex="-1"><a class="header-anchor" href="#什么是享元模式" aria-hidden="true">#</a> 什么是享元模式</h2>
...
<figure><img src="@source/design-pattern/images/flyweight.png" alt="flyweight" tabindex="0" loading="lazy"><figcaption>flyweight</figcaption></figure>
<ul>
<li>
<p>Flyweight: 享元接口</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> flyweight
