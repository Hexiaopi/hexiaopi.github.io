<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/bridge/bridge-2x.png" alt="bridge" tabindex="0" loading="lazy"><figcaption>bridge</figcaption></figure>
<!-- more -->
<h2 id="场景问题" tabindex="-1"><a class="header-anchor" href="#场景问题" aria-hidden="true">#</a> 场景问题</h2>
<p>假设你有一个几何形状类Shape，从它扩展出两个子类：圆形Cicle和方形Square，你希望对这样的类进行扩展使其包含两种颜色：Blue、Red。</p>
<figure><img src="@source/design-pattern/images/bridge-question.png" alt="bridge-question" tabindex="0" loading="lazy"><figcaption>bridge-question</figcaption></figure>
<p>很快你会发现，如果新增形状类，例如: 三角形，椭圆形。或者新增颜色，子类的数量将会暴躁式增长。</p>
<p>为了解决这些问题，我们可以用桥接模式来将图形的形状和颜色分离为两个层次结构，让它们可以独立地变化。</p>
<h2 id="什么是桥接模式" tabindex="-1"><a class="header-anchor" href="#什么是桥接模式" aria-hidden="true">#</a> 什么是桥接模式</h2>
...
<figure><img src="@source/design-pattern/images/bridge.png" alt="bridge" tabindex="0" loading="lazy"><figcaption>bridge</figcaption></figure>
<ul>
<li>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> bridge
...
<span class="token keyword">func</span> <span class="token function">ExampleOperation</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	<span class="token comment">// ConcreateImplB</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="解决场景问题" tabindex="-1"><a class="header-anchor" href="#解决场景问题" aria-hidden="true">#</a> 解决场景问题</h3>
<p>回到本文前面的问题，那么我们如何使用桥接模式解决该问题呢</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> shape
...
<h3 id="桥接设计模式和适配器设计模式的区别" tabindex="-1"><a class="header-anchor" href="#桥接设计模式和适配器设计模式的区别" aria-hidden="true">#</a> 桥接设计模式和适配器设计模式的区别</h3>
