<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/proxy/proxy-2x.png" alt="proxy" tabindex="0" loading="lazy"><figcaption>proxy</figcaption></figure>
<!-- more -->
<h2 id="什么是代理模式" tabindex="-1"><a class="header-anchor" href="#什么是代理模式" aria-hidden="true">#</a> 什么是代理模式</h2>
...
<figure><img src="@source/design-pattern/images/proxy.png" alt="代理模式" tabindex="0" loading="lazy"><figcaption>代理模式</figcaption></figure>
<ul>
<li>
<p>Subject: 抽象主题</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> proxy
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token comment">// Subject 接口定义</span>
<span class="token keyword">type</span> Subject <span class="token keyword">interface</span> <span class="token punctuation">{</span>
...
<h3 id="虚拟代理" tabindex="-1"><a class="header-anchor" href="#虚拟代理" aria-hidden="true">#</a> 虚拟代理</h3>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token comment">// Image 接口定义</span>
...
<h3 id="保护代理" tabindex="-1"><a class="header-anchor" href="#保护代理" aria-hidden="true">#</a> 保护代理</h3>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token comment">// Subject 接口定义</span>
<span class="token keyword">type</span> Subject <span class="token keyword">interface</span> <span class="token punctuation">{</span>
    <span class="token function">Request</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
...
<h3 id="日志记录代理" tabindex="-1"><a class="header-anchor" href="#日志记录代理" aria-hidden="true">#</a> 日志记录代理</h3>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token comment">// Subject 接口定义</span>
<span class="token keyword">type</span> Subject <span class="token keyword">interface</span> <span class="token punctuation">{</span>
    <span class="token function">Request</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
...
<h3 id="代理模式和装饰器模式" tabindex="-1"><a class="header-anchor" href="#代理模式和装饰器模式" aria-hidden="true">#</a> 代理模式和装饰器模式</h3>
<ul>
...
<h3 id="代理模式和-middleware" tabindex="-1"><a class="header-anchor" href="#代理模式和-middleware" aria-hidden="true">#</a> 代理模式和 Middleware</h3>
