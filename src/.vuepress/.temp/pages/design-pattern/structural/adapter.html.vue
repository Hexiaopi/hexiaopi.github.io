<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/adapter/adapter-zh-2x.png" alt="adapter" tabindex="0" loading="lazy"><figcaption>adapter</figcaption></figure>
<!-- more -->
<h2 id="什么是适配器模式" tabindex="-1"><a class="header-anchor" href="#什么是适配器模式" aria-hidden="true">#</a> 什么是适配器模式</h2>
...
<figure><img src="@source/design-pattern/images/adapter.png" alt="适配器" tabindex="0" loading="lazy"><figcaption>适配器</figcaption></figure>
<ul>
<li>
<p>Target: 目标角色</p>
<p>该角色定义是用户期望的接口</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> adapter
...
<li>保证系统的稳定性：适配器设计模式可以让已有的系统保持稳定，不必对其进行修改，只是增加新的功能。满足开闭原则。</li>
</ul>
