<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/facade/facade-2x.png" alt="facade" tabindex="0" loading="lazy"><figcaption>facade</figcaption></figure>
<!-- more -->
<h2 id="什么是外观模式" tabindex="-1"><a class="header-anchor" href="#什么是外观模式" aria-hidden="true">#</a> 什么是外观模式</h2>
...
<figure><img src="@source/design-pattern/images/facade.png" alt="外观" tabindex="0" loading="lazy"><figcaption>外观</figcaption></figure>
<p>外观模式经常在我们不知不觉中使用，例如：MVC架构中，Controller层对外提供简单的接口，Controller层包含多个Service层进行功能划分，每个Service层也可能包含多个Dao层进行数据操作。</p>
<figure><img src="@source/design-pattern/images/facade-mvc.png" alt="mvc" tabindex="0" loading="lazy"><figcaption>mvc</figcaption></figure>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> facade
