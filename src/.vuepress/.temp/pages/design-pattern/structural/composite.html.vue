<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/composite/composite-2x.png" alt="composite" tabindex="0" loading="lazy"><figcaption>composite</figcaption></figure>
<!-- more -->
<h2 id="某一场景问题" tabindex="-1"><a class="header-anchor" href="#某一场景问题" aria-hidden="true">#</a> 某一场景问题</h2>
<p>例如：有两类对象：<code v-pre>产品</code>和<code v-pre>盒子</code>，<code v-pre>盒子</code>中可以包含多个<code v-pre>产品</code>或者小<code v-pre>盒子</code>，在此基础需要知道这个盒子的总价格，如果直接打开所有的盒子，累加产品的价值，虽然可行。但对计算机会增加许多繁杂的细节。</p>
<p>那么使用组合模式，就可以很好的简化这个细节，如果是<code v-pre>产品</code>就直接返回价格，如果是<code v-pre>盒子</code>，则遍历盒子中的所有项目，累加价格。最大的优点，<code v-pre>产品</code>和<code v-pre>盒子</code>提供一致的接口，你无需了解内部结构，只需要调用这一个接口即可。</p>
<h2 id="什么是组合模式" tabindex="-1"><a class="header-anchor" href="#什么是组合模式" aria-hidden="true">#</a> 什么是组合模式</h2>
...
<figure><img src="@source/design-pattern/images/composite.png" alt="composite" tabindex="0" loading="lazy"><figcaption>composite</figcaption></figure>
<ul>
<li>
...
<h3 id="有哪些分类" tabindex="-1"><a class="header-anchor" href="#有哪些分类" aria-hidden="true">#</a> 有哪些分类</h3>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> composite
