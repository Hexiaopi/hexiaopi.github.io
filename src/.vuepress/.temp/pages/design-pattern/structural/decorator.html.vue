<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/decorator/decorator-2x.png" alt="decorator" tabindex="0" loading="lazy"><figcaption>decorator</figcaption></figure>
<!-- more -->
<h2 id="什么是装饰器模式" tabindex="-1"><a class="header-anchor" href="#什么是装饰器模式" aria-hidden="true">#</a> 什么是装饰器模式</h2>
...
<figure><img src="@source/design-pattern/images/decorator.png" alt="decorator" tabindex="0" loading="lazy"><figcaption>decorator</figcaption></figure>
<ul>
<li>
<p>Component: 组件接口</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> decorator
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">func</span> <span class="token function">ExampleComponent</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h3 id="装饰器设计模式和适配器设计模式" tabindex="-1"><a class="header-anchor" href="#装饰器设计模式和适配器设计模式" aria-hidden="true">#</a> 装饰器设计模式和适配器设计模式</h3>
