<template><div><!-- more -->
<h2 id="什么是简单工厂模式" tabindex="-1"><a class="header-anchor" href="#什么是简单工厂模式" aria-hidden="true">#</a> 什么是简单工厂模式</h2>
...
<figure><img src="@source/design-pattern/images/simple-factory.png" alt="simple-factory" tabindex="0" loading="lazy"><figcaption>simple-factory</figcaption></figure>
<ul>
<li>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> simple_factory
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="有哪些应用场景" tabindex="-1"><a class="header-anchor" href="#有哪些应用场景" aria-hidden="true">#</a> 有哪些应用场景</h3>
<ul>
...
<p>例如：</p>
<ul>
<li>对于<strong>门</strong>这个产品，我们只需要给定的<strong>材料</strong>参数，工厂就会给我们创建<code v-pre>木门</code>、<code v-pre>铁门</code>、<code v-pre>玻璃门</code>等等。</li>
</ul>
...
<p>简单工厂设计模式是一种创建型设计模式，它可以根据参数的不同，返回不同类的实例，而无需让客户端知道具体的创建细节。简单工厂设计模式有利于实现对象的创建和使用分离，降低了系统的耦合性，提高了系统的灵活性和可维护性。但是，简单工厂设计模式也有缺点，它扩展性差，如果要增加新的产品类，就需要修改工厂类的代码，违背了开闭原则。而且，工厂类的职责过重，如果产品种类较多，工厂方法的代码将会非常复杂。因此，简单工厂设计模式适用于创建对象少且不关心创建过程的场景。</p>
</div></template>
