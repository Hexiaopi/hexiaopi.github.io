<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/builder/builder-zh-2x.png" alt="builder" tabindex="0" loading="lazy"><figcaption>builder</figcaption></figure>
<!-- more -->
<h2 id="什么是建造者模式" tabindex="-1"><a class="header-anchor" href="#什么是建造者模式" aria-hidden="true">#</a> 什么是建造者模式</h2>
...
<figure><img src="@source/design-pattern/images/builder.png" alt="建造者模式" tabindex="0" loading="lazy"><figcaption>建造者模式</figcaption></figure>
<ul>
<li>
<p>Product：产品角色</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> builder
