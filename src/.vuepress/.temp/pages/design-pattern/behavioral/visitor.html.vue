<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/visitor/visitor-2x.png" alt="visitor" tabindex="0" loading="lazy"><figcaption>visitor</figcaption></figure>
<!-- more -->
<h2 id="什么是访问者模式" tabindex="-1"><a class="header-anchor" href="#什么是访问者模式" aria-hidden="true">#</a> 什么是访问者模式</h2>
...
<figure><img src="@source/design-pattern/images/visitor.png" alt="visitor" tabindex="0" loading="lazy"><figcaption>visitor</figcaption></figure>
<ul>
<li>
<p>Visitor: 访问者</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> visitor
...
<h3 id="在不修改已有代码的情况下-向已有类层次结构增加新的行为" tabindex="-1"><a class="header-anchor" href="#在不修改已有代码的情况下-向已有类层次结构增加新的行为" aria-hidden="true">#</a> 在不修改已有代码的情况下，向已有类层次结构增加新的行为</h3>
