<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/memento/memento-zh-2x.png" alt="memento" tabindex="0" loading="lazy"><figcaption>memento</figcaption></figure>
<!-- more -->
<h2 id="什么是备忘录模式" tabindex="-1"><a class="header-anchor" href="#什么是备忘录模式" aria-hidden="true">#</a> 什么是备忘录模式</h2>
...
<figure><img src="@source/design-pattern/images/memento.png" alt="memento" tabindex="0" loading="lazy"><figcaption>memento</figcaption></figure>
<ul>
<li>
<p>Originator: 原发器</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> memento
