<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/state/state-zh-2x.png" alt="state" tabindex="0" loading="lazy"><figcaption>state</figcaption></figure>
<!-- more -->
<h2 id="什么是状态模式" tabindex="-1"><a class="header-anchor" href="#什么是状态模式" aria-hidden="true">#</a> 什么是状态模式</h2>
...
<figure><img src="@source/design-pattern/images/state.png" alt="state" tabindex="0" loading="lazy"><figcaption>state</figcaption></figure>
<ul>
<li>
<p>Context: 上下文</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> state
