<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/mediator/mediator-2x.png" alt="mediator" tabindex="0" loading="lazy"><figcaption>mediator</figcaption></figure>
<!-- more -->
<h2 id="什么是中介者模式" tabindex="-1"><a class="header-anchor" href="#什么是中介者模式" aria-hidden="true">#</a> 什么是中介者模式</h2>
...
<figure><img src="@source/design-pattern/images/mediator.png" alt="mediator" tabindex="0" loading="lazy"><figcaption>mediator</figcaption></figure>
<ul>
<li>
<p>Mediator：中介者</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> mediator
