<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/observer/observer-2x.png" alt="observer" tabindex="0" loading="lazy"><figcaption>observer</figcaption></figure>
<!-- more -->
<h2 id="什么是观察者模式" tabindex="-1"><a class="header-anchor" href="#什么是观察者模式" aria-hidden="true">#</a> 什么是观察者模式</h2>
...
<figure><img src="@source/design-pattern/images/observer.png" alt="observer" tabindex="0" loading="lazy"><figcaption>observer</figcaption></figure>
<ul>
<li>
<p>Observer: 观察者</p>
<p>声明了通知接口，在绝大数情况下，该接口仅包含一个<code v-pre>update</code>方法，该方法可以有多个参数</p>
</li>
<li>
<p>Subject: 主题</p>
<p>提供一个用于存储观察者对象的聚集类，该类通常包含<code v-pre>注册</code>和<code v-pre>取消注册</code>观察者的方法，以及通知所有观察者变化的方法。</p>
</li>
<li>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> observer
