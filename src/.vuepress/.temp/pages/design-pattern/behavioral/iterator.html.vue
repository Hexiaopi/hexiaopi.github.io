<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/iterator/iterator-zh-2x.png" alt="iterator" tabindex="0" loading="lazy"><figcaption>iterator</figcaption></figure>
<!-- more -->
<h2 id="什么是迭代器模式" tabindex="-1"><a class="header-anchor" href="#什么是迭代器模式" aria-hidden="true">#</a> 什么是迭代器模式</h2>
...
<figure><img src="@source/design-pattern/images/iterator.png" alt="iterator" tabindex="0" loading="lazy"><figcaption>iterator</figcaption></figure>
<ul>
<li>
<p>Iterator: 迭代器接口</p>
<p>声明了遍历集合所需的操作</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> iterator
