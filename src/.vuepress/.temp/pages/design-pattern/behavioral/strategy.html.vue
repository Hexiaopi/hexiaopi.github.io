<template><div><figure><img src="https://refactoringguru.cn/images/patterns/content/strategy/strategy-2x.png" alt="strategy" tabindex="0" loading="lazy"><figcaption>strategy</figcaption></figure>
<!-- more -->
<h2 id="什么是策略模式" tabindex="-1"><a class="header-anchor" href="#什么是策略模式" aria-hidden="true">#</a> 什么是策略模式</h2>
...
<figure><img src="@source/design-pattern/images/strategy.png" alt="strategy" tabindex="0" loading="lazy"><figcaption>strategy</figcaption></figure>
<ul>
<li>
<p>Strategy: 策略接口</p>
...
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> strategy
