<template><div><figure><img src="https://jvns.ca/images/sql-queries.jpeg" alt="sql-queries" tabindex="0" loading="lazy"><figcaption>sql-queries</figcaption></figure>
<!-- more -->
...
<p>需要注意的是，在实际实现中，MySQL会根据具体的查询条件和数据量进行一定的优化和调整。在涉及查询性能或者与索引有关的东西时，这张图就不适用了。<Badge text="注意" type="warning"/></p>
<h2 id="详细查询顺序" tabindex="-1"><a class="header-anchor" href="#详细查询顺序" aria-hidden="true">#</a> 详细查询顺序</h2>
<p>1.FROM子句<br>
...
<p><a href="https://jvns.ca/blog/2019/10/03/sql-queries-don-t-start-with-select/" target="_blank" rel="noopener noreferrer">SQL查询不是以select开始<ExternalLinkIcon/></a></p>
</div></template>
