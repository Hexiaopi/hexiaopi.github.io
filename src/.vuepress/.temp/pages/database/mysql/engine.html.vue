...
<figure><img src="@source/database/mysql/images/MySQL-Architecture.png" alt="MySQL架构" tabindex="0" loading="lazy"><figcaption>MySQL架构</figcaption></figure>
...
<h3 id="innodb引擎" tabindex="-1"><a class="header-anchor" href="#innodb引擎" aria-hidden="true">#</a> Innodb引擎</h3>
<blockquote>
...
<li>使用三个文件定义一个表：
<ul>
<li><code v-pre>.MYi</code>：存储索引</li>
<li><code v-pre>.MYD</code>：存储数据</li>
<li><code v-pre>.frm</code>：存储表定义</li>
</ul>
</li>
...
<h4 id="注意事项-1" tabindex="-1"><a class="header-anchor" href="#注意事项-1" aria-hidden="true">#</a> 注意事项</h4>
<ul>
<li>设置合适索引</li>
...
<h2 id="引擎对比" tabindex="-1"><a class="header-anchor" href="#引擎对比" aria-hidden="true">#</a> 引擎对比</h2>
<table>
<thead>
<tr>
