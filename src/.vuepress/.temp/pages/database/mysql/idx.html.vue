<template><div><p>索引是一种数据结构，帮助SQL高效获取数据的。类似一本书的目录，可以快速对特定值进行定位和查找，从而大大加快数据查询的效率。</p>
<!-- more -->
<h2 id="索引优缺点" tabindex="-1"><a class="header-anchor" href="#索引优缺点" aria-hidden="true">#</a> 索引优缺点</h2>
<h3 id="索引优点" tabindex="-1"><a class="header-anchor" href="#索引优点" aria-hidden="true">#</a> 索引优点</h3>
<ul>
...
<h3 id="索引缺点" tabindex="-1"><a class="header-anchor" href="#索引缺点" aria-hidden="true">#</a> 索引缺点</h3>
<ul>
...
<p>MySQL单张表最多只支持16个索引<Badge text="注意" type="warning"/></p>
<h2 id="索引类型" tabindex="-1"><a class="header-anchor" href="#索引类型" aria-hidden="true">#</a> 索引类型</h2>
<h3 id="按功能逻辑划分" tabindex="-1"><a class="header-anchor" href="#按功能逻辑划分" aria-hidden="true">#</a> 按功能逻辑划分</h3>
<h4 id="普通索引" tabindex="-1"><a class="header-anchor" href="#普通索引" aria-hidden="true">#</a> 普通索引</h4>
...
<h4 id="全文索引" tabindex="-1"><a class="header-anchor" href="#全文索引" aria-hidden="true">#</a> 全文索引</h4>
<p>mysql Like '%xxx'就会导致索引失效，为了模糊搜索需求，例如：like '%hello%'，就需要全文索引支持。InnoDB在5.6版本之后支持全文索引。</p>
<h3 id="按物理逻辑划分" tabindex="-1"><a class="header-anchor" href="#按物理逻辑划分" aria-hidden="true">#</a> 按物理逻辑划分</h3>
...
<h3 id="按字段个数划分" tabindex="-1"><a class="header-anchor" href="#按字段个数划分" aria-hidden="true">#</a> 按字段个数划分</h3>
<h4 id="单一索引" tabindex="-1"><a class="header-anchor" href="#单一索引" aria-hidden="true">#</a> 单一索引</h4>
<p>索引只使用一个字段</p>
<h4 id="联合索引" tabindex="-1"><a class="header-anchor" href="#联合索引" aria-hidden="true">#</a> 联合索引</h4>
<p>索引使用多个字段<br>
例如：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>alert <span class="token keyword">table</span> <span class="token keyword">user</span> <span class="token keyword">add</span> <span class="token keyword">index</span> index_name_city_age<span class="token punctuation">(</span>name<span class="token punctuation">,</span>city<span class="token punctuation">,</span>age<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>MySQL联合索引遵从：最左匹配原则</p>
<p>上面索引相当于建立下面三组索引：</p>
<ul>
<li>name,city,age</li>
<li>name,city</li>
...
<h3 id="索引推荐使用情况" tabindex="-1"><a class="header-anchor" href="#索引推荐使用情况" aria-hidden="true">#</a> 索引推荐使用情况</h3>
<ul>
<li>WHERE, GROUP BY, ORDER BY 子句中的字段</li>
<li>多个单列索引在多条件查询是只会有一个最优的索引生效，因此多条件查询中最好创建联合索引。</li>
<li>联合索引的时候必须满足最左匹配原则，并且最好考虑到 sql 语句的执行顺序，比如 WHERE a = 1 GROUP BY b ORDER BY c, 那么联合索引应该设计为 (a,b,c)，因为mysql 查询语句的执行顺序 WHERE &gt; GROUP BY &gt; ORDER BY。<RouterLink to="/database/mysql/sql-order.html">参见</RouterLink></li>
...
<h3 id="不推荐使用或索引失效情况" tabindex="-1"><a class="header-anchor" href="#不推荐使用或索引失效情况" aria-hidden="true">#</a> 不推荐使用或索引失效情况</h3>
<ul>
<li>数据量很小的表</li>
<li>有大量重复数据的字段</li>
<li>频繁更新的字段</li>
