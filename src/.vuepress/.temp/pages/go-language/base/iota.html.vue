...
<!-- more -->
<h2 id="iota" tabindex="-1"><a class="header-anchor" href="#iota" aria-hidden="true">#</a> iota</h2>
<blockquote>
<p>iota是Go语言的一个预定义标识符，它表示的是const声明块或声明行中每个常量所处位置的<strong>偏移值</strong>（从0开始）。</p>
</blockquote>
<h3 id="规则-如果按行递增-可省略后续的iota关键字" tabindex="-1"><a class="header-anchor" href="#规则-如果按行递增-可省略后续的iota关键字" aria-hidden="true">#</a> 规则：如果按行递增，可省略后续的iota关键字</h3>
<p>例如：</p>
...
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="规则-iota只跟常量组的偏移位置有关" tabindex="-1"><a class="header-anchor" href="#规则-iota只跟常量组的偏移位置有关" aria-hidden="true">#</a> 规则：iota只跟常量组的偏移位置有关</h3>
<p>‼️</p>
<p>例如：</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">const</span> <span class="token punctuation">(</span>
...
<h3 id="规则-每遇到一个const关键字-iota就会重置为0" tabindex="-1"><a class="header-anchor" href="#规则-每遇到一个const关键字-iota就会重置为0" aria-hidden="true">#</a> 规则：每遇到一个const关键字，iota就会重置为0</h3>
<p>例如：</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">const</span> x <span class="token operator">=</span> <span class="token boolean">iota</span> <span class="token comment">//iota=0</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="规则-iota跟个数无关-即便是同一行-值也都一样" tabindex="-1"><a class="header-anchor" href="#规则-iota跟个数无关-即便是同一行-值也都一样" aria-hidden="true">#</a> 规则：iota跟个数无关，即便是同一行，值也都一样</h3>
<p>‼️</p>
<p>例如：</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">const</span> <span class="token punctuation">(</span>
...
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>虽然g,h是两个常量，但由于在同一行，iota的值一样</p>
<h3 id="规则-如果想从1开始-则可以通过-忽略第一个iota" tabindex="-1"><a class="header-anchor" href="#规则-如果想从1开始-则可以通过-忽略第一个iota" aria-hidden="true">#</a> 规则：如果想从1开始，则可以通过<code v-pre>_</code>忽略第一个iota</h3>
<p>例如：</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">const</span> <span class="token punctuation">(</span>
