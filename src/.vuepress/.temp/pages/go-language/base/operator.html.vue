<template><div><p>程序、表达式、运算符之间的关系</p>
<blockquote>
...
<p>赋值运算格式如下：</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token operator">&lt;</span>变量名称<span class="token operator">></span> <span class="token operator">=</span> <span class="token operator">&lt;</span>操作数<span class="token operator">></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>也可以在定义变量时同时赋值，格式如下：</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">var</span> <span class="token operator">&lt;</span>变量名称<span class="token operator">></span> <span class="token punctuation">[</span>变量类型<span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token operator">&lt;</span>操作数<span class="token operator">></span>
...
<h3 id="通道运算符" tabindex="-1"><a class="header-anchor" href="#通道运算符" aria-hidden="true">#</a> 通道运算符</h3>
<p>通道运算符使用<code v-pre>&lt;-</code>接受或者发送数据</p>
<h2 id="运算符的优先级和结合" tabindex="-1"><a class="header-anchor" href="#运算符的优先级和结合" aria-hidden="true">#</a> 运算符的优先级和结合</h2>
...
<td style="text-align:center"><code v-pre>*</code> <code v-pre>/</code> <code v-pre>%</code> <code v-pre>&lt;&lt;</code> <code v-pre>&gt;&gt;</code> <code v-pre>&amp;</code> <code v-pre>&amp;^</code></td>
<td style="text-align:center">二元运算符</td>
</tr>
<tr>
<td style="text-align:center">5</td>
<td style="text-align:center"><code v-pre>+</code> <code v-pre>-</code> <code v-pre>|</code> <code v-pre>^</code></td>
<td style="text-align:center">二元运算符</td>
</tr>
<tr>
<td style="text-align:center">4</td>
<td style="text-align:center"><code v-pre>==</code> <code v-pre>!=</code> <code v-pre>&lt;</code> <code v-pre>&lt;=</code> <code v-pre>&gt;=</code> <code v-pre>&gt;</code></td>
