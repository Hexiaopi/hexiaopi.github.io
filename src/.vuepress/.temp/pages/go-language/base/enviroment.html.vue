...
<figure><img src="@source/go-language/base/images/GOPATH.png" alt="GOPATH" tabindex="0" loading="lazy"><figcaption>GOPATH</figcaption></figure>
<p>此外，还有几个环境变量需要关注:</p>
<ol>
...
<li>GOPROXY，Go包下载代理服务器，因为墙的原因，国内无法访问国外的一些网站，但一些依赖包需要从国外的网站下载，为了解决这个问题，需要设置一个代理服务器。例如：<code v-pre>GOPROXY=&quot;https://goproxy.cn,direct&quot;</code>，其中direct的作用是当遇见404错误，则直接去目标地址（比如Github）去获取，而不再使用代理服务器。</li>
<li>GOPRIVATE，用于配置访问私有化仓库的代理，例如：<code v-pre>GOPRIVATE=git.xxx.com/</code></li>
</ol>
</div></template>
