...
<h4 id="一个变量" tabindex="-1"><a class="header-anchor" href="#一个变量" aria-hidden="true">#</a> 一个变量</h4>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">var</span> <span class="token operator">&lt;</span>variable_name<span class="token operator">></span> <span class="token punctuation">[</span>variable_type<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>例如：</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">var</span> x <span class="token builtin">int</span>			<span class="token comment">//自动初始化int的零值即0</span>
...
<ul>
<li>编译器确保变量被初始化为<code v-pre>零值</code>，避免出现不可预测行为</li>
<li>定义的变量如果未使用，会编译不通过</li>
</ul>
<h4 id="多个变量" tabindex="-1"><a class="header-anchor" href="#多个变量" aria-hidden="true">#</a> 多个变量</h4>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token comment">//不同类型变量</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="短变量" tabindex="-1"><a class="header-anchor" href="#短变量" aria-hidden="true">#</a> 短变量</h4>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code>count <span class="token operator">:=</span> <span class="token number">10</span> <span class="token comment">//编译器自动推断为int类型</span>
...
<li>
<p>由于使用了<code v-pre>:=</code>，因此至少有一个<code v-pre>新声明的变量</code>出现在左值，否则编译失败</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">var</span> x<span class="token punctuation">,</span>y <span class="token builtin">int</span>
...
<h4 id="匿名变量" tabindex="-1"><a class="header-anchor" href="#匿名变量" aria-hidden="true">#</a> 匿名变量</h4>
<blockquote>
<p>匿名变量是以下划线<code v-pre>_</code>声明的，通常用于多值返回时忽略某个值</p>
</blockquote>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code>result<span class="token punctuation">,</span><span class="token boolean">_</span> <span class="token operator">:=</span> json<span class="token punctuation">.</span><span class="token function">Marshal</span><span class="token punctuation">(</span>s<span class="token punctuation">)</span> <span class="token comment">//忽略err</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="零值" tabindex="-1"><a class="header-anchor" href="#零值" aria-hidden="true">#</a> 零值</h3>
<blockquote>
...
<li><code v-pre>function</code>、<code v-pre>interface</code>、<code v-pre>map</code>、<code v-pre>slice</code>、<code v-pre>channel</code>等类型为nil，表示没有分配内存地址</li>
<li><code v-pre>struct</code>和<code v-pre>array</code>则是分配了内存，其子元素对应上述的零值</li>
</ul>
...
<h4 id="局部变量" tabindex="-1"><a class="header-anchor" href="#局部变量" aria-hidden="true">#</a> 局部变量</h4>
<blockquote>
<p>局部变量（Local Variables）是在函数内部或<code v-pre>{}</code>内定义的变量，它的作用范围仅限域函数内部或<code v-pre>{}</code>内。</p>
</blockquote>
<p>👀</p>
