<template><div><h2 id="命名规则" tabindex="-1"><a class="header-anchor" href="#命名规则" aria-hidden="true">#</a> 命名规则</h2>
<blockquote>
...
<li>大小写敏感，比如<code v-pre>x</code>和<code v-pre>X</code>是两个不一样的标识符；</li>
</ul>
</div></template>
