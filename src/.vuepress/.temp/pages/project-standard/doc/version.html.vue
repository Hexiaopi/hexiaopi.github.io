...
<!-- more -->
<h2 id="语义化版本规范" tabindex="-1"><a class="header-anchor" href="#语义化版本规范" aria-hidden="true">#</a> 语义化版本规范</h2>
<blockquote>
<p>语义化版本规范（SemVer,Semantic Versioning）是Github起草的一个具有指导意义的、统一的版本号表示规范。<br>
它规定了版本号的表示、增加和比较方式，以及不同版本号代表的含义。</p>
</blockquote>
<p>语义化版本格式为：<code v-pre>主版本号.次版本号.修订号（X.Y.Z）</code>，其中X、Y和Z为非负整数，且禁止在数字前方补零。<br>
例如：v1.2.3</p>
<p>版本号增加的含义：</p>
<ul>
...
<figure><img src="@source/project-standard/images/semver.png" alt="server" tabindex="0" loading="lazy"><figcaption>server</figcaption></figure>
<p>一些经验：</p>
<ul>
...
<p>关于语义化版本规范详细内容参考：<a href="https://semver.org/lang/zh-CN/" target="_blank" rel="noopener noreferrer">semver.org<ExternalLinkIcon/></a></p>
<h2 id="先行版本" tabindex="-1"><a class="header-anchor" href="#先行版本" aria-hidden="true">#</a> 先行版本</h2>
...
<p>另外可以使用一些工具规范版本号：</p>
<ul>
<li><a href="https://github.com/arnaud-deprez/gsemver" target="_blank" rel="noopener noreferrer">gsemver<ExternalLinkIcon/></a>
<ul>
<li>使用<code v-pre>gsemver bump</code>命令就可以根据Git历史提交约定生成下一个版本</li>
</ul>
</li>
<li><a href="https://github.com/commitizen/cz-cli" target="_blank" rel="noopener noreferrer">cz-cli<ExternalLinkIcon/></a></li>
</ul>
</div></template>
